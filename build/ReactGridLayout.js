  ...
  /*: void*/
  {
    ...
    _defineProperty(_assertThisInitialized(_this), "onDragOver", function (e) {
      ...
      var _this$props = _this.props,
          ...
          _this$props$draggable = _this$props.draggableInitialPosition,
          draggableInitialPosition = _this$props$draggable === void 0 ? {
        x: 0,
        y: 0,
        w: 0,
        h: 0
      ...
      if (!_this.state.droppingDOMNode) {
        ...
        var collisions = (0, _utils.getAllCollisions)(sorted, _objectSpread(_objectSpread({}, calculatedPosition), droppingItem));
